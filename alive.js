...
const ALIVE_IMG = "https://files.catbox.moe/umz8ez.jpg"; // Assurez-vous que cette URL est valide
...
cmd({
    ...
    try {
        ...
        const formattedInfo = `
🌿 *CHANUKA-MD MD STATUS* 🌿
Hey 👋🏻 ${pushname}
🕒 *Time*: ${currentTime}
📅 *Date*: ${currentDate}
⏳ *Uptime*: ${runtimeHours} hours, ${runtimeMinutes} minutes, ${runtimeSeconds} seconds

*🤖sᴛᴀᴛᴜs*: *ᴄʜᴀɴᴜᴋᴀ-ᴍᴅ ᴀʟɪᴠᴇ ᴀɴᴅ ʀᴇᴀᴅʏ*
